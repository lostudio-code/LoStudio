...
(function () {
  ...
  <svg viewBox="0 0 320 240" fill="none" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Brand identity — letterform construction">
    <circle class="b-ring b-ring1" cx="138" cy="120" r="76" stroke="#fff" stroke-opacity=".16" stroke-width="1.5" stroke-dasharray="3 7"></circle>
    <circle class="b-ring b-ring2" cx="138" cy="120" r="47" stroke="#fff" stroke-opacity=".12" stroke-width="1.5" stroke-dasharray="3 7"></circle>
    ...
    <circle class="b-dot" cx="84" cy="146" r="3.5" fill="${V}"></circle>
    <circle class="b-dot b-dot2" cx="192" cy="146" r="3.5" fill="${V}"></circle>
    <rect class="b-chip" x="256" y="78" width="28" height="28" rx="8" fill="${V}"></rect>
  ...
  <svg viewBox="0 0 320 240" fill="none" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Web design — browser wireframe">
    ...
    <rect class="w-btn" x="56" y="136" width="64" height="24" rx="12" fill="${V}"></rect>
    ...
    <g class="w-cursor"><g transform="translate(112 150)"><path d="M0 0l0 13 3.4-3 2.2 4.8 2.4-1.1-2.2-4.7 4.6-.3z" fill="#fff" stroke="#141414" stroke-width="1" stroke-linejoin="round"></path></g></g>
  </svg>`;
  ...
  <svg viewBox="0 0 320 240" fill="none" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Product UI — dashboard wireframe">
    ...
    <rect class="p-bar" x="122" y="156" width="14" height="24" rx="3" fill="#fff" fill-opacity=".25"></rect>
    <rect class="p-bar" style="animation-delay:.12s" x="146" y="142" width="14" height="38" rx="3" fill="#fff" fill-opacity=".25"></rect>
    <rect class="p-bar" style="animation-delay:.24s" x="170" y="150" width="14" height="30" rx="3" fill="#fff" fill-opacity=".25"></rect>
    <rect class="p-bar" style="animation-delay:.36s" x="194" y="128" width="14" height="52" rx="3" fill="${V}"></rect>
    <rect class="p-bar" style="animation-delay:.48s" x="218" y="138" width="14" height="42" rx="3" fill="#fff" fill-opacity=".25"></rect>
    <rect class="p-bar" style="animation-delay:.60s" x="242" y="118" width="14" height="62" rx="3" fill="#fff" fill-opacity=".25"></rect>
    <path class="p-line" d="M122 148l28-18 28 8 28-24 44-10" stroke="${V}" stroke-width="2.5" stroke-opacity=".9"></path>
    <circle class="p-dot" cx="250" cy="104" r="4" fill="${V}"></circle>
  </svg>`;
  ...
  <svg viewBox="0 0 320 240" fill="none" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Motion and video — player with edit timeline">
    ...
    <g class="v-play"><circle cx="160" cy="92" r="26" fill="${V}"></circle>
    <path d="M153 80l22 12-22 12z" fill="#161616"></path></g>
    ...
    <g class="v-head"><line x1="150" y1="170" x2="150" y2="220" stroke="#fff" stroke-width="2"></line>
    <path d="M144 164h12l-6 8z" fill="#fff"></path></g>
  </svg>`;
  ...
  <svg viewBox="0 0 320 240" fill="none" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="Go-to-market — launching rocket">
    ...
    <g class="s-rocket"><g transform="rotate(38 178 108)">
      ...
      <path class="s-flame" d="M168 138c2 14 10 24 10 24s8-10 10-24" stroke="${V}" stroke-width="2.5"></path>
    </g></g>
    <path class="s-spark" d="M262 52v16M254 60h16" stroke="${V}" stroke-width="2.5"></path>
    <path class="s-spark s-spark2" d="M66 78v12M60 84h12" stroke="#fff" stroke-opacity=".35" stroke-width="2"></path>
