  ...
  const PROJECTS = [
    {
      ...
      hero: 'https://lostudio.net/wp-content/uploads/2024/05/Website-Featured.png',
      showcase: 'https://lostudio.net/wp-content/uploads/2024/05/Website-Featured.png',
      showcaseUrl: 'projectdiscovery.io',
      ...
      galleryLayout: 'grid',
      gallery: [
        {cap:'Homepage', theme:'web', img:'../uploads/Website-Homepage.png'},
        {cap:'Vulnerability management', theme:'web', img:'../uploads/Website-Vulnerability-Management.png'},
        {cap:'Pricing', theme:'web', img:'../uploads/Website-Pricing.png'},
        {cap:'Enterprise', theme:'web', img:'../uploads/Website-Enterprise.png'},
        {cap:'Launch week', theme:'web', img:'../uploads/Website-Launch-Week.png'},
        {cap:'Case study', theme:'web', img:'../uploads/Website-Case-Study-50978f6a.png'},
        {cap:'Weekly report email', theme:'web', img:'../uploads/Email-Weekly-Report.png'},
        {cap:'Vulnerability scan email', theme:'web', img:'../uploads/Email-Vulnerability-Scan.png'},
        {cap:'Platform menu', theme:'web', span:'full', img:'../uploads/Menu - Platform.png'},
        {cap:'Playtika social card', theme:'social', img:'https://lostudio.net/wp-content/uploads/2025/05/ProjectDiscovery-Playtika-Social.png'},
        {cap:'Elastic testimonial campaign', theme:'social', img:'https://lostudio.net/wp-content/uploads/2025/05/Testimonial_Campaign_Elastic.png'},
        {cap:'100k GitHub stars · animated', theme:'social', img:'https://lostudio.net/wp-content/uploads/2024/12/100k_GitHub_Stars_v2.gif'},
        {cap:'AI-powered Nuclei template generation', theme:'social', img:'../uploads/Blog-Nuclei.png'}
      ]
    },
    {
      ...
      hero: 'https://lostudio.net/wp-content/uploads/2025/02/ProjectDiscovery_Primary_Logo_Featured.png',
      ...
      galleryLayout: 'grid',
      gallery: [
        {cap:'Cover', theme:'brand', img:'../uploads/Brand Guidelines - 1.png'},
        {cap:'Introduction', theme:'brand', img:'../uploads/Brand Guidelines - 2.png'},
        {cap:'Attributes', theme:'brand', img:'../uploads/Brand Guidelines - 3.png'},
        {cap:'Language', theme:'brand', img:'../uploads/Brand Guidelines - 4.png'},
        {cap:'Logo mark', theme:'brand', img:'../uploads/Brand Guidelines - 5.png'},
        {cap:'Primary logo', theme:'brand', img:'../uploads/Brand Guidelines - 6.png'},
        {cap:'Secondary logo', theme:'brand', img:'../uploads/Brand Guidelines - 7.png'},
        {cap:'Geist', theme:'brand', img:'../uploads/Brand Guidelines - 8.png'},
        {cap:'Hierarchy', theme:'brand', img:'../uploads/Brand Guidelines - 9.png'},
        {cap:'Size', theme:'brand', img:'../uploads/Brand Guidelines - 10.png'},
        {cap:'Geist Mono', theme:'brand', img:'../uploads/Brand Guidelines - 11.png'},
        {cap:'Primary color', theme:'brand', img:'../uploads/Brand Guidelines - 12.png'},
        {cap:'Palette', theme:'brand', img:'../uploads/Brand Guidelines - 13.png'},
        {cap:'Shades', theme:'brand', img:'../uploads/Brand Guidelines - 14.png'},
        {cap:'Vulnerabilities', theme:'brand', img:'../uploads/Brand Guidelines - 15.png'},
        {cap:'Gradients', theme:'brand', img:'../uploads/Brand Guidelines - 16.png'},
        {cap:'Color mix', theme:'brand', img:'../uploads/Brand Guidelines - 17.png'},
        {cap:'Bringing our brand to life', theme:'brand', img:'../uploads/Brand Guidelines - 18.png'},
        {cap:'Space', theme:'brand', img:'../uploads/Brand Guidelines - 19.png'},
        {cap:'Grids', theme:'brand', img:'../uploads/Brand Guidelines - 20.png'},
        {cap:'Product', theme:'brand', img:'../uploads/Brand Guidelines - 21.png'},
        {cap:'Photography', theme:'brand', img:'../uploads/Brand Guidelines - 22.png'},
        {cap:'Illustrations', theme:'brand', img:'../uploads/Brand Guidelines - 23.png'},
        {cap:'Icons', theme:'brand', img:'../uploads/Brand Guidelines - 24.png'},
        {cap:'Ads', theme:'brand', img:'../uploads/Brand Guidelines - 25.png'},
        {cap:'Swag', theme:'brand', img:'../uploads/Brand Guidelines - 26.png'}
      ]
    },
    {
      ...
      hero: 'https://lostudio.net/wp-content/uploads/2026/03/vulnerability-sh-ssearch-darkmode-thumb.png',
      ...
      galleryLayout: 'grid',
      gallery: [
        {cap:'Search · dark', theme:'product', img:'../uploads/vulnerability-sh-ssearch-darkmode.png'},
        {cap:'Search · light', theme:'product', img:'../uploads/vulnerability-sh-search-lightmode.png'},
        {cap:'Products · dark', theme:'product', img:'../uploads/vulnerability-sh-products-darkmode.png'},
        {cap:'Products · light', theme:'product', img:'../uploads/vulnerability-sh-products-lightmode.png'},
        {cap:'Stats · dark', theme:'product', img:'../uploads/vulnerability-sh-stats-darkmode.png'},
        {cap:'Stats · light', theme:'product', img:'../uploads/vulnerability-sh-stats-lightmode.png'},
        {cap:'Library · dark', theme:'product', img:'../uploads/vulnerability-sh-library-darkmode.png'},
        {cap:'Library · light', theme:'product', img:'../uploads/vulnerability-sh-library-lightmode.png'}
      ]
    },
    {
      ...
      hero: 'https://lostudio.net/wp-content/uploads/2024/05/HSS_Thumbnail.png',
      ...
      gallery: [
        ...
        {cap:'Confirmation email', theme:'event', span:'half tall', img:'https://lostudio.net/wp-content/uploads/2024/05/HSS-Email-1-Confirmation.png'},
        {cap:'Speaker · PJ Metz', theme:'event', span:'half', img:'https://lostudio.net/wp-content/uploads/2024/05/HSS_PJ_Metz.png'},
        {cap:'Speaker · Liz Rice', theme:'event', span:'half', img:'https://lostudio.net/wp-content/uploads/2024/05/HSS_Liz_Rice.png'},
        {cap:'On the ground · 01', theme:'event', span:'half tall', img:'https://lostudio.net/wp-content/uploads/2024/05/Brendan_1.jpg'},
        {cap:'On the ground · 02', theme:'event', span:'half tall', img:'https://lostudio.net/wp-content/uploads/2024/05/Aaron_1.jpg'},
        {cap:'On the ground · 03', theme:'event', span:'half tall', img:'https://lostudio.net/wp-content/uploads/2024/05/MichaelSam.jpg'},
        {cap:'On the ground · 04', theme:'event', span:'half tall', img:'https://lostudio.net/wp-content/uploads/2024/05/Waffle_5.jpg'}
      ]
    },
    {
      ...
      gallery: [
        {cap:'Build vs Buy', theme:'web', img:'../uploads/Build_vs_Buy.png', span:'half tall'},
        {cap:'Case Studies', theme:'web', img:'../uploads/Case_Studies.png', span:'half tall'},
        {cap:'Code References', theme:'web', img:'../uploads/Code_References.png', span:'half tall'},
        {cap:'Enterprise', theme:'web', img:'../uploads/Enterprise.png', span:'half tall'},
        {cap:'Our Customers', theme:'web', img:'../uploads/Our_Customers.png', span:'half tall'},
        {cap:'Security', theme:'web', img:'../uploads/Security.png', span:'half tall'},
        {cap:'Solution', theme:'web', img:'../uploads/Solution.png', span:'half tall'},
        {cap:'The Definitive Guide to Feature Management', theme:'web', img:'../uploads/The_Definitive_Guide_to_Feature_Management.png', span:'half tall'},
        {cap:'What is Feature Management', theme:'web', img:'../uploads/What_is_Feature_Management.png', span:'half tall'},
        {cap:'Why LaunchDarkly', theme:'web', img:'../uploads/Why_LaunchDarkly.png', span:'half tall'}
      ]
    },
    {
      ...
      hero: 'https://lostudio.net/wp-content/uploads/2022/05/HP_Release.png',
      summary: 'Designed product interfaces across LaunchDarkly’s feature-management platform, with flows and components that made powerful controls feel simple. Feature management is deceptively complex, between targeting, rollouts, and experiments, so the UI had to keep all that power accessible to every engineer. I designed flows and components for flag management, targeting, and experimentation, including responsive and mobile.',
      ...
      galleryLayout: 'grid',
      gallery: [
        {cap:'Release confidently', theme:'product', span:'full', img:'../uploads/1_Release_Confidentialy-84a07bcb.png'},
        {cap:'Improve reliability', theme:'product', span:'full', img:'../uploads/2_Improve_Reliability-3782a307.png'},
        {cap:'Safely migrate systems', theme:'product', span:'full', img:'../uploads/3_Safely_Migrate_Systems-6027ae61.png'},
        {cap:'Run actionable experiments', theme:'product', span:'full', img:'../uploads/4_Run_Actionable_Experiments-f50660e8.png'},
        {cap:'SDKs', theme:'product', span:'full', img:'../uploads/5_SDKs-b6440c8b.png'},
        {cap:'APIs', theme:'product', span:'full', img:'../uploads/6_APIs-7a0befba.png'},
        {cap:'Integrations', theme:'product', span:'full', img:'../uploads/7_Integrations-70d5edb0.png'},
        {cap:'Code references', theme:'product', span:'full', img:'../uploads/8_Code_References-023d9e30.png'},
        {cap:'Experimentation', theme:'product', span:'full', img:'../uploads/9_Experimentation-fd81e67a.png'},
        {cap:'Data export', theme:'product', span:'full', img:'../uploads/10_Data_Export-d7ece312.png'},
        {cap:'Feature flags', theme:'product', span:'full', img:'../uploads/11_Feature_Flags-2cca8e07.png'},
        {cap:'Feature workflows', theme:'product', span:'full', img:'../uploads/12_Feature_Workflows-34ac2b80.png'},
        {cap:'Platform architecture', theme:'product', span:'full', img:'../uploads/13_Platform_Architecture-025f974d.png'},
        {cap:'Test innovations collaboratively', theme:'product', span:'full', img:'../uploads/14_Test_Innovations.png'},
        {cap:'Scale safe releases', theme:'product', span:'full', img:'../uploads/15_Scale_Safe_Releases.png'},
        {cap:'Accelerate app modernization', theme:'product', span:'full', img:'../uploads/16_App_Modernization.png'},
        {cap:'Filter for any repository and branch', theme:'product', span:'full', img:'../uploads/17_Filter_by_Repository.png'},
        {cap:'Search for references by alias', theme:'product', span:'full', img:'../uploads/18_Search_for_References.png'},
        {cap:'Discover when a flag was last referenced', theme:'product', span:'full', img:'../uploads/19_Discover_when_a_Flag.png'},
        {cap:'Workflow automation', theme:'product', span:'full', img:'../uploads/20_Workflow_Automation.png'},
        {cap:'Advanced targeting', theme:'product', span:'full', img:'../uploads/21_Advanced_Targeting.png'},
        {cap:'Technical debt management', theme:'product', span:'full', img:'../uploads/22_Technical_Debt_Management.png'},
        {cap:'Security and administration', theme:'product', span:'full', img:'../uploads/23_Security_and_Administration.png'}
      ]
    },
    {
    ...
    },
    {
      ...
      gallery: [
        {cap:'Q4 release video', theme:'video', yt:'QjsxmT2hR7k', img:'https://lostudio.net/wp-content/uploads/2023/04/Winter_16x9.png'}
      ]
    },
    {
      id: 'launchdarkly-bumpers', company: 'LaunchDarkly', title: 'Video Bumpers',
      cat: 'Motion', kind: 'Video', year: '2022', accent: LD, theme: 'video', size: 'sm',
      hero: 'https://lostudio.net/wp-content/uploads/2022/03/Zendesk_Integration_Thumb.png',
      ...
      gallery: [
        {cap:'Zendesk integration', theme:'video', yt:'GVvdXy1UBho', img:'https://lostudio.net/wp-content/uploads/2022/05/Zendesk_Integration.png'},
        {cap:'Customer Corner bumper', theme:'video', yt:'h4EXf0QFyBY', img:'https://lostudio.net/wp-content/uploads/2022/03/Customer_Corner_Bumper.png'},
        {cap:'Academy · Code References', theme:'video', yt:'vq7ssPCNVYU', img:'https://lostudio.net/wp-content/uploads/2022/03/Academy_Getting-Started-with-Code-References-in-LaunchDarkly.png'},
        {cap:'A Day in the Life · intro', theme:'video', yt:'48LLb09IVuQ', img:'https://lostudio.net/wp-content/uploads/2022/03/A_Day_in_the_Life_Intro.png'}
      ]
    },
    {
      ...
      hero: 'https://lostudio.net/wp-content/uploads/2022/09/Galaxy_LastStop_Promo_1080x1080_02.png',
    ...
    },
    {
      ...
      hero: 'uploads/Uberflip_Explainer.png',
      ...
      galleryLayout: 'grid',
      gallery: [
        {cap:'LaunchDarkly explainer', theme:'social', img:'../uploads/Uberflip_Explainer.png'},
        {cap:'What customers are saying', theme:'social', img:'../uploads/Testimonial - All.png'},
        {cap:'How to create feature flags in LaunchDarkly', theme:'social', img:'../uploads/FFT_How to create feature flags in LaunchDarkly.png'},
        {cap:'Data Dog integration', theme:'social', img:'../uploads/Data_Dog.png'},
        {cap:'DevOps at Speed with Feature Flags', theme:'social', img:'../uploads/FFT_ DevOps at Speed with Feature Flags.png'},
        {cap:'Feature toggles & hypothesis-driven development', theme:'social', img:'../uploads/FFT_ Feature toggles & hypothesis-driven development _ DevNation Tech Talk.png'},
        {cap:'Deploying rapidly for CI · Heidi Waterhouse', theme:'social', img:'../uploads/FFT_Deploying rapidly for continuous integration with Heidi Waterhouse.png'},
        {cap:'Enabling Continuous Delivery with Feature Flags', theme:'social', img:'../uploads/FFT_Enabling Continuous Delivery with Feature Flags & LaunchDarkly.png'},
        {cap:'How Atlassian Does DevOps · Building Products', theme:'social', img:'../uploads/FFT_How Atlassian Does DevOps Webinar - Building Products.png'},
        {cap:'SOC2 is not a 4-letter word', theme:'social', img:'../uploads/FFT_SOC2 is not a 4 letter word_ A startup guide to compliance.png'},
        {cap:'When feature flags go bad', theme:'social', img:'../uploads/FFT_When Feature flags go bad.png'},
        {cap:'Targeting · Taking your feature flags further', theme:'social', img:'../uploads/GS_Targeting- Taking Your Feature Flags Further.png'},
        {cap:'Test in production · for product managers', theme:'social', img:'../uploads/TIP_How LaunchDarkly Enables Product Managers to Test in Production.png'},
        {cap:'Trajectory Nano · Making releases boring', theme:'social', img:'../uploads/Trajectory Nano Series Week 1 of 4_ Making Releases Boring in the Enterprise.png'},
        {cap:'AMA with Jon Smart · DOES U.S. Virtual', theme:'social', img:'../uploads/Uberflip_AMA with Jon Smart (DOES U.S. Virtual).png'},
        {cap:'Code References', theme:'social', img:'../uploads/Uberflip_Code_Refs.png'},
        {cap:'Dynatrace webinar', theme:'social', img:'../uploads/Webinars_Dynatrace Webinar.png'},
        {cap:'The Fallacy of Move Fast and Break Things', theme:'social', img:'../uploads/Webinars_The Fallacy of Move Fast and Break Things.png'}
      ]
    },
    {
      id: 'launchdarkly-ads', company: 'LaunchDarkly', title: 'eBook Ads',
      cat: 'Motion', kind: 'Campaign', year: '2022', accent: LD, theme: 'ads', size: 'sm',
      hero: 'https://lostudio.net/wp-content/uploads/2022/03/eBook_Thumb.png',
